...
public class ComponentFragment extends BaseFragment {
    ...
    private static final String TAG = ComponentFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_component_layout, container, false);
