...
public class TemplateMethodFragment extends BaseFragment {
     ...
     * number.
     */
    public static TemplateMethodFragment newInstance() {
        TemplateMethodFragment fragment = new TemplateMethodFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_template_method_layout, container, false);
